...
<div class="panel blob-config-panel" id="blob-config-panel">
    <formgroup class="form-group" id="blob-settings">
        <?php echo $this->form->label(e('Blob key'), 'blob_key') ?>
        <?php echo $this->form->text('blob_key', $values) ?>

        <?php echo $this->form->label(e('Blob bucket ID'), 'blob_bucket_id') ?>
    ...
    <formgroup class="form-group" id="mimetype-settings">
        <?php echo $this->form->label(e('Allowed MIME types to upload'), 'blob_allowed_mime_types') ?>
        <?php echo $this->form->textarea('blob_allowed_mime_types', $values) ?>
        <p class="form-help"><?= e('Format: one MIME type per line')?></p>
    ...
    <formgroup class="form-group" id="upload-settings">
        <?php echo $this->form->label(e('Maximum file upload size in MB'), 'blob_allowed_max_file_upload_size') ?>
